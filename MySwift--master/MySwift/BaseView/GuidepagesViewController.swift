...
//            pageControl.setValue(UIImage.init(named:"huahuitiao"), forKey: "pageImage")//当前
//            pageControl.setValue(UIImage.init(named:"hualantiao"), forKey: "currentPageImage") //选中
            
//            pageControl.preferredCurrentPageIndicatorImage = UIImage.init(named: "huahuitiao")
            pageControl.currentPageIndicatorTintColor = .lightGray
            pageControl.pageIndicatorTintColor = .white
//            pageControl.setCurrentPageIndicatorImage(UIImage.init(named: "huahuitiao"), forPage: 0)
