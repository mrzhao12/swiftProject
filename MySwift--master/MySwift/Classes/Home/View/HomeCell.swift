...
class HomeCell: UITableViewCell {
    ...
    func setUpUI(){
        ...
        titleLab = UILabel.init(frame: CGRect(x: 45, y: 5, width: 200, height: 40))
        ...
        detailLab = UILabel.init(frame: CGRect(x: 45, y: 50, width: 200, height: 40))
